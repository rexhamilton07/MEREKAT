  ...
  return (
    <div className='AboutDiv'>
      ...
      <p className = "bio">
        ...
        <br></br><br></br>Over the last few years, the intimate venues of Montréal have served as both their workshop and canvas, where the band experiments with the infectious energy that defines their live performances. 
